...
public class OI {
  ...
  public void bindControls() {
    ...
    rightJoystick.getJoystickButton(LogitechJoystick.BUTTON_11).whileHeld(new ClimbUp());
    rightJoystick.getJoystickButton(LogitechJoystick.BUTTON_10).whileHeld(new ClimbDown());
