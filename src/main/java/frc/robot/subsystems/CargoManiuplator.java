...
public class CargoManiuplator extends Subsystem {
  ...
  public final double SPIN_IN_SPEED = -0.15;
  public final double REVERSE_OUT_SPEED = -0.75;
  public final double REVERSE_IN_SPEED = 0.15;
  public final double STOP_SPEED = 0.00;
  
  public WPI_TalonSRX cargoManipulatorMotorLeft = new WPI_TalonSRX(RobotMap.cargoManipulatorPortLeft);
  public WPI_TalonSRX cargoManipulatorMotorRight = new WPI_TalonSRX(RobotMap.cargoManipulatorPortRight);
  ...
  public CargoManiuplator() {
    ...
    cargoManipulatorMotorLeft.setInverted(true);
